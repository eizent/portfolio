...
Please check out my [resume]({{ site.baseurl }}/resume/), my [portfolio]({{ site.baseurl }}/portfolio/) to see samples of my instructional design work, as well as my [digital projects]({{ site.baseurl }}/digi_proj/).
