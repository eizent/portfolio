...
Please check out my [resume]({{ site.baseurl }}/resume/) and my [portfolio]({{ site.baseurl }}/portfolio/) to see samples of my instructional design and digital scholarship work. 
